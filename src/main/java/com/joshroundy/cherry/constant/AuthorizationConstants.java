...
public class AuthorizationConstants {
    ...
    public static final String PASSWORD_ERROR_MESSAGE = "Password must be at least 8 characters long and include uppercase, lowercase, number, and special character";
