...
public class AuthorizationConstants {
    public static final String USERNAME_REGEX = "^[a-zA-Z0-9]{3,18}$";
    public static final String USERNAME_ERROR_MESSAGE = "Username must be alphanumeric and less than 18 characters";
