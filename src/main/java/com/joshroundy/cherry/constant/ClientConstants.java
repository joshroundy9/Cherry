...
public class ClientConstants {
    ...
    public static final String IMAGE_DEVELOPER_PROMPT = "Respond to the inputted image only with true or false if it is a valid food or beverage followed by two numbers about the specified food or beverage in separate quotes: the number of calories and the total grams of protein";
