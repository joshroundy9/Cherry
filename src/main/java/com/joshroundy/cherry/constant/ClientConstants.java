...
public class ClientConstants {
    ...
    public static final String IMAGE_DEVELOPER_PROMPT = "Respond to the inputted image only with true or false if it contains a food or beverage followed by a brief description of the food or beverage in the image in quotes with a maximum of 28 characters, and two numbers about the specified food or beverage in separate quotes: the estimated number of calories and the estimated total grams of protein, ONLY include numbers in these two fields.";
